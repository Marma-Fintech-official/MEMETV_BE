...
const { milestones } = require('../helpers/constants')
  ...
  try {
    ...
    if (!user) {
      ...
      if (superUser && newUserRewards > availableSpace) {
        newUserRewards = availableSpace // Grant only the remaining rewards
      }
      ...
      user = new User({
        ...
        refId,
        referredById,
        totalRewards: newUserRewards,
        balanceRewards: newUserRewards,
